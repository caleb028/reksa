    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative overflow-hidden bg-slate-950 py-16 lg:py-24 text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=2000&q=85"
            alt="Modern Kenyan Apartments for Rent"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/40 bg-indigo-950/60 px-3.5 py-1 text-xs font-semibold text-indigo-300 backdrop-blur-md mb-4">
              <KeyRound className="h-4 w-4 text-indigo-400" />
              <span>Apartments for Rent in Kenya</span>
            </div>
            ...
            <p className="mt-4 text-sm sm:text-base lg:text-lg text-slate-300 leading-relaxed max-w-2xl">
              Search apartments for rent using intelligent filters, neighbourhood insights, verified service charges, and trusted property information.
            </p>

            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href="#rental-listings"
                className="rounded-2xl bg-indigo-600 px-5 py-3 text-xs sm:text-sm font-bold text-white shadow-premium hover:bg-indigo-500 transition-all"
              >
                Browse Rentals ({rentalApartments.length})
              </a>
      ...
      <section id="rental-listings" className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 w-full flex-1">
        {/* Filter Toolbar */}
        <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 mb-8">
          <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100 dark:border-slate-800">
            <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-500">
              ...
              <span>Rental Search Filters</span>
            </span>
            <span className="text-xs font-bold text-indigo-600">
              {rentalApartments.length} verified rentals available
            </span>
          </div>
          ...
          <form method="GET" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 text-xs">
            ...
            {/* Max Rent */}
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Max Rent / mo</label>
              <select
                name="maxRent"
              ...
              >
                ...
                <option value="150000">Under KES 150,000</option>
                <option value="250000">Under KES 250,000</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="lowest_price">Rent: Low to High</option>
                <option value="highest_price">Rent: High to Low</option>
            ...
            <div className="flex items-end">
              <button
                type="submit"
                className="w-full rounded-xl bg-indigo-600 p-2 font-bold text-white hover:bg-indigo-500 transition-colors"
              >
                Apply Filters
              </button>
            </div>
        ...
        {rentalApartments.length > 0 ? (
          ...
          <div className="rounded-3xl border border-dashed border-slate-300 p-12 text-center dark:border-slate-700">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">No rental apartments found</h3>
            <p className="text-xs text-slate-500 mt-1 max-w-md mx-auto">
              Try adjusting your monthly rent ceiling or expanding the location search to find available leases.
            </p>
